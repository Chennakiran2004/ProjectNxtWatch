...
describe("MenuItemsList Component", () => {
    ...
    it("should change active menu item on click", () => {
        ...
        fireEvent.click(homeLink)
        expect(homeLink.closest('li')).toHaveStyle('background-color: rgb("66, 66, 66)');

        fireEvent.click(trendingLink);
        expect(trendingLink.closest('li')).toHaveStyle('background-color: rgb("66, 66, 66)');

        fireEvent.click(GamingLink);
        expect(GamingLink.closest('li')).toHaveStyle('background-color: rgb("66, 66, 66)');

        fireEvent.click(savedVideosLink);
        expect(savedVideosLink.closest('li')).toHaveStyle('background-color: rgb("66, 66, 66)');
    });
